...
def main():
    ...
    while run:
        ...
        pothers = n.send([(gir.tipo,gir.counter,gir.live,gir.x,gir.y),(rect.tipo,rect.counter,rect.live,rect.x,rect.y),(cir.tipo,cir.counter,cir.live,cir.x,cir.y),(rect2.tipo,rect2.counter,rect2.live,rect2.x,rect2.y),(rect3.tipo,rect3.counter,rect3.live,rect3.x,rect3.y),(rect4.tipo,rect4.counter,rect4.live,rect4.x,rect4.y),(rect5.tipo,rect5.counter,rect5.live,rect5.x,rect5.y)])
